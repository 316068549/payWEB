    ...
    <el-form ref="form" :model="form" label-width="80px" >
      ...
      <el-form-item label="套餐">
        <el-select v-model="form.region" placeholder="请选择套餐" >
          <el-option label="一个月100元" value="0.01"></el-option>
...
//        alert(d.errmsg);
  ...
  import {order} from '../../apiconfig/api.config';
...
//                   out_trade_no:'70501111111S001111119',product_code:'QUICK_WAP_WAY',timeout_express:"90m"};
          ...
          params.append('deviceId', this.form.name);
          ...
          order(params).then(res=>{
            ...
            if(!ak){
              ...
              let ordUrl = '/order/'+res.data.data.id;
